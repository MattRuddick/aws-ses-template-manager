...
(async function () {
  ...
  $(document).ready(function () {
    if (sessionStorage.getItem('versionOutdated')) {
      ...
      $('body').append(`
        <a id="newVersionIndicator" href="https://github.com/MattRuddick/ses-template-manager/releases/tag/${latestVersion}" target="_blank" data-toggle="tooltip" data-placement="bottom" data-html="true" title="<code>git pull</code> for latest version">
